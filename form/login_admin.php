...
<body>
    ...
    <div class="line d-flex justify-content-start" style="background-color: crimson">
        <ul><a href="login.php" style="color: white; font-weight: bold; text-decoration: none;">Login as User</a></ul>
    </div>


    <!-- Form -->
    <form action="../process/aksi_loginadmin.php?op=in" method="POST" class="fill-style">
        <h4>Log In Admin</h4>
        <div class="mb-3">
            <div class="row">
                <div class="col">

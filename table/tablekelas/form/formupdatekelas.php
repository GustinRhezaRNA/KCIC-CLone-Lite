                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="tipekelas" class="form-control" id="tipekelas" aria-describedby="tipekelas" required />
                        </div>
                        <div class="col">
                            <label for="harga" class="form-label">Harga</label>
                            <input type="text" name="harga" class="form-control" id="harga" aria-describedby="harga" required />
                        </div>

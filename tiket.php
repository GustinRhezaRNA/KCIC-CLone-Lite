...
$sqlPembayaran = "SELECT * from pembayaran WHERE id_transaksi = $id_transaksi";
    ...
    <div class="container-tiket">
        ...
        <div class="data1">
            ...
            <div class="col jadwal">
                ...
                <div class="row"><?= $dt_kelas['id_kelas'] ?>-<?php echo $dt_kursi['no_kursi'] ?></div>
